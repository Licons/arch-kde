    ...
    Loader {
        ...
        Kirigami.Icon {
            ...
            ParallelAnimation {
                ...
                // Pulse glow
                SequentialAnimation {
                    PropertyAnimation { target: glowIcon; property: "opacity"; to: 1.0; duration: 120; easing.type: Easing.OutQuad }
                    PropertyAnimation { target: glowIcon; property: "opacity"; to: 0.0; duration: 140; easing.type: Easing.InOutQuad }
                    PropertyAnimation { target: glowIcon; property: "opacity"; to: 0.6; duration: 120; easing.type: Easing.InOutQuad }
                    PropertyAnimation { target: glowIcon; property: "opacity"; to: 0.0; duration: 160; easing.type: Easing.OutQuad }
                }

                // Bounce (scale)
                SequentialAnimation {
                    PropertyAnimation { target: icon; property: "scale"; to: 1.6; duration: 120; easing.type: Easing.OutQuad }
                    PropertyAnimation { target: icon; property: "scale"; to: 1.1; duration: 140; easing.type: Easing.InOutQuad }
                    PropertyAnimation { target: icon; property: "scale"; to: 1.3; duration: 120; easing.type: Easing.InOutQuad }
                    PropertyAnimation { target: icon; property: "scale"; to: 1.1; duration: 160; easing.type: Easing.OutQuad }
                }

                // Wobble (rotation)
                SequentialAnimation {
                    PropertyAnimation { target: icon; property: "rotation"; to: 10; duration: 100; easing.type: Easing.InOutQuad }
                    PropertyAnimation { target: icon; property: "rotation"; to: -10; duration: 120; easing.type: Easing.InOutQuad }
                    PropertyAnimation { target: icon; property: "rotation"; to: 0; duration: 160; easing.type: Easing.OutQuad }
                }
            }
            ...
            ParallelAnimation {
                id: resetAnim
                PropertyAnimation { target: icon; property: "scale"; to: 1.0; duration: 160; easing.type: Easing.InOutQuad }
                PropertyAnimation { target: icon; property: "rotation"; to: 0; duration: 160; easing.type: Easing.InOutQuad }
                PropertyAnimation { target: glowIcon; property: "opacity"; to: 0; duration: 160; easing.type: Easing.InOutQuad }
            }
        }
    ...
    states: [
        ...
        State {
            ...
            PropertyChanges {
                ...
                scale: 1.0 // bắt đầu từ scale bình thường
            }
        },
        State {
            name: "minimized"
    ...
    transitions: [
        Transition {
            ...
            SequentialAnimation {
                ...
                // Trở lại bình thường với bounce
                NumberAnimation {
                    target: frame
                    property: "scale"
                    from: 0.95
